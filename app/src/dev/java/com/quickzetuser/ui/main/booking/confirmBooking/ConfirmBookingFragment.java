package com.quickzetuser.ui.main.booking.confirmBooking;
...
import com.quickzetuser.model.pusher.PusherEtaModel;
...
import com.quickzetuser.model.web_response.BookingDetailResponseModel;
...
import com.quickzetuser.ui.main.dialog.confirmationDialog.ConfirmationDialog;
import com.quickzetuser.ui.utilities.BookingStatusHelper;
import com.squareup.picasso.Picasso;

import java.util.List;

import static com.quickzetuser.appBase.AppBaseMapFragment.getPusherEtaDropEventName;
    ...
    private void handleBookingStatusUpdate(boolean showMessage) {
        if (this.bookCabModel != null) {
            if (this.bookCabModel.getStatus() == -1) {
                ...
                revertToFareEstimateScreen();
            } else if (this.bookCabModel.getStatus() == 7) {  // quickzetuser side cancel
                revertToFareEstimateScreen();
